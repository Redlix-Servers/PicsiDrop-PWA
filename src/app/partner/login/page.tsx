...
import { handlePartnerSignIn, handlePartnerSignUp } from '../../actions/authActions';
...
const PartnerLoginPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    const action = isSignIn ? handlePartnerSignIn : handlePartnerSignUp;
    ...
    if (result.success) {
      ...
      setTimeout(() => {
        const targetUrl = isSignIn 
          ? '/partner/dashboard' 
          : `/partner/kyc?email=${encodeURIComponent(formData.email)}`;
    ...
    <div className="flex min-h-screen w-full bg-[#fcfcfc] font-sans">
      ...
      <div className="flex w-full items-center justify-center lg:w-[35%] relative py-12 px-6 overflow-y-auto">
        <div className="relative w-full max-w-[400px] bg-white p-8 border border-gray-100 rounded-none shadow-[0_2px_15px_-3px_rgba(0,0,0,0.02)]">
          ...
          <div className="mb-10 flex flex-col items-center">
            ...
            <div className="flex items-center">
              <span className="text-3xl font-light tracking-tight text-black">
                ...
                <span className="ml-2 text-xs font-bold text-gray-400 uppercase tracking-widest leading-none pt-1">
                 Partner
                </span>
              </span>
            </div>
          ...
          <div className="space-y-5 px-1">
            ...
            >
              {isLoading ? (message?.type === 'success' ? 'Redirecting...' : 'Processing...') : (isSignIn ? 'Sign In' : 'Register as Partner')}
            </button>
            ...
            <button className="w-full flex items-center justify-center space-x-3 py-3.5 border border-gray-200 hover:bg-gray-50 transition-colors rounded-none group">
                ...
                <span className="text-sm font-normal text-black">Workspace Login</span>
            </button>
          </div>
          ...
          <div className="mt-10 text-center">
            ...
            >
              {isSignIn ? "New tracking partner? Create an account" : "Back to Partner Sign In"}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="relative hidden w-[65%] lg:block overflow-hidden transition-all duration-1000 ease-in-out">
        <Image
          ...
          alt={isSignIn ? "Partner Sign in background" : "Partner Creating account background"}
          fill
